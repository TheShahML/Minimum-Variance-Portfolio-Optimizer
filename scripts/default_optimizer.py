"""
Portfolio Optimization Script - Assignment Version
Modularized version of the original 2000-line notebook
Uses interactive inputs with comprehensive validation
"""
...
def main():
    ...
    try:
        ...
        if results['success']:
            ...
            # Save results
            print("\n" + "=" * 70)
            save = input("Save results to file? (y/n): ").lower().strip()
            if save in ['y', 'yes']:
